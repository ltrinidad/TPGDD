...
(
	...
	username VARCHAR(20) UNIQUE NOT NULL FOREIGN KEY REFERENCES LOS_CHATADROIDES.Usuario(username),
	habilitado BIT NOT NULL DEFAULT 1,
...
-- PROBAR SI ALGUNO DE LOS CAMPOS DE LA PK COMPUESTA PUEDE SER NULL
